...
class ValidationTest {
    ...
    void testAdvancedValidate() {
        Address address1 = new Address("Russia", "Ufa", "Lenina", "054", null);
        ...
        Map<String, List<String>> expected2 = Map.of("country", List.of("can not be null"),
                "houseNumber", List.of("length less than 3"));
        assertThat(result2).isEqualTo(expected2);

        Address address3 = new Address("USA", null, null, null, "1");
        Map<String, List<String>> result3 = Validator.advancedValidate(address3);
        Map<String, List<String>> expected3 = Map.of("city", List.of("can not be null", "length less than 4"),
                "street", List.of("can not be null"),
                "houseNumber", List.of("can not be null", "length less than 3"));
        assertThat(result3).isEqualTo(expected3);

        Address address4 = new Address("Russia", "Moscow", "Lenina", "054", null);
