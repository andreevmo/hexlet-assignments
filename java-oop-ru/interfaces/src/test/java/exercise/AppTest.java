...
class AppTest {
    ...
    @Test
    void testToString() {
        String testLine = "fedcba";
        assertThat(new ReversedSequence("abcdef").toString()).isEqualTo(testLine);
    ...
    void testCharAt() {
        String testLine = "fedcba";
        assertThat(new ReversedSequence("abcdef").charAt(2)).isEqualTo(testLine.charAt(2));
    }

    @Test
    void testLength() {
        String testLine = "fedcba";
        assertThat(new ReversedSequence("abcdef").length()).isEqualTo(testLine.length());
    }

    @Test
    void testSubSequence() {
        String testLine = "fedcba";
        assertThat(new ReversedSequence("abcdef").subSequence(1, 5)).isEqualTo(testLine.substring(1, 5));
    }
    // END
}
