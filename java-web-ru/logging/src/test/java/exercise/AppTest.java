...
class AppTest {
    ...
    // BEGIN
    @Test
    public static void testAnswerCodeForGetRequest() throws IOException {
        CloseableHttpClient httpClient = HttpClients.createDefault();
        HttpGet httpGet = new HttpGet(baseUrl + "/new");

        List<NameValuePair> param = new ArrayList<>();
        param.add(new BasicNameValuePair("email", "maxiandreev1994@gmail.com"));
